...
export function detectProviders() {
  ...
  const antigravity = checkProviderAvailability({
    configDirs: [join(home, '.gemini', 'antigravity')],
    custom: () => true // Always surface as an option
  });
  ...
  return [
    { id: 'antigravity', name: 'Antigravity (Google)', ...antigravity },
