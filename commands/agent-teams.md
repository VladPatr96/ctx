---
name: agent-teams
description: Use when facing complex tasks needing parallel collaboration between multiple agents with shared state, coordination, and direct inter-agent communication. Triggers on "create team", "agent team", "team of agents"
---
...
GOOD: "Fix JWT expiry bug in src/auth/jwt.ts. Token refresh fails when
